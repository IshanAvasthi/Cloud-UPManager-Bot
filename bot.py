...
async def start(bot, cmd):
	await cmd.reply_text("HI, I am Cloud Uploads Manager Bot!\n\nI can Do a Lot of Things, Check > /help <", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/IshanAvasthi"), InlineKeyboardButton("Support Group", url="https://t.me/IshanUpdates")], [InlineKeyboardButton("Bots Channel", url="https://t.me/IshanUpdates")], [InlineKeyboardButton("Bot's Source Code", url="https://github.com/IshanAvasthi/Cloud-UPManager-Bot")]]))
...
async def help(bot, cmd):
	await cmd.reply_text(
		...
		reply_markup=InlineKeyboardMarkup(
			[
				[InlineKeyboardButton("Support Group", url="https://t.me/IshanUpdates"), InlineKeyboardButton("Developer", url="https://t.me/IshanAvasthi")],
		...
		if not int(query.from_user.id) == Config.BOT_OWNER:
			answers.append(
				InlineQueryResultArticle(
					...
					reply_markup=InlineKeyboardMarkup(
						[
							[InlineKeyboardButton("Support Group", url="https://t.me/IshanUpdates")],
							[InlineKeyboardButton("Developer", url="https://t.me/IshanAvasthi")]
						]
					)
				)
			)
